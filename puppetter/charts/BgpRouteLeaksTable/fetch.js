...
const BgpRouteLeaksTable = async (req, res, location, dateStart, dateEnd) => {

  
  // Build the base URL
  let url = 'https://radar.cloudflare.com/charts/BgpRouteLeaksTable/fetch?';
...
module.exports = { BgpRouteLeaksTable };
