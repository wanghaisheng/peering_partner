...
const TrafficVolumeXY = async (req, res, location, dateStart, dateEnd) => {
  

  // Build the base URL
  let url = 'https://radar.cloudflare.com/charts/TrafficVolumeXY/fetch?';
...
module.exports = { TrafficVolumeXY };
