...
const BgpRoutesRpkiHalfDonut = async (req, res, location, dateStart, dateEnd) => {
  

  // Build the base URL
  let url = 'https://radar.cloudflare.com/charts/BgpRoutesRpkiHalfDonut/fetch?';
...
module.exports = { BgpRoutesRpkiHalfDonut };
