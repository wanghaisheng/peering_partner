...
const TrafficTrendsXY = async (req, res, location, dateStart, dateEnd) => {
  

  // Build the base URL
  let url = 'https://radar.cloudflare.com/charts/TrafficTrendsXY/fetch?';
...
module.exports = { TrafficTrendsXY };
