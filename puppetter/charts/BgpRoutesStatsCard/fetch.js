...
const BgpRoutesStatsCard = async (req, res, location, dateStart, dateEnd) => {
  

  // Build the base URL
  let url = 'https://radar.cloudflare.com/charts/BgpRoutesStatsCard/fetch?';
...
module.exports = { BgpRoutesStatsCard };
