...
const HttpVersionBubble = async (req, res, location, dateStart, dateEnd) => {
  

  // Build the base URL
  let url = 'https://radar.cloudflare.com/charts/HttpVersionBubble/fetch?';
...
module.exports = { HttpVersionBubble };
