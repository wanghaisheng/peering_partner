...
const BgpRoutesIpv6HalfDonut = async (req, res, location, dateStart, dateEnd) => {
  

  // Build the base URL
  let url = 'https://radar.cloudflare.com/charts/BgpRoutesIpv6HalfDonut/fetch?';
...
module.exports = { BgpRoutesIpv6HalfDonut };
