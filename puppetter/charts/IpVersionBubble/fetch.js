...
const IpVersionBubble = async (req, res, location, dateStart, dateEnd) => {
  

  // Build the base URL
  let url = 'https://radar.cloudflare.com/charts/IpVersionBubble/fetch?';
...
module.exports = { IpVersionBubble };
