...
const Layer34AttacksBubble = async (req, res, location, dateStart, dateEnd) => {
  

  // Build the base URL
  let url = 'https://radar.cloudflare.com/charts/Layer34AttacksBubble/fetch?';
...
module.exports = { Layer34AttacksBubble };
