...
export default function DownstreamsDetailsInfo({ res_downstreams, asn_number }: PrefixesDetailsInfoProps) {
            ...
            <div className="md:flex md:flex-wrap">
              <div className="w-full p-4 bg-white border border-gray-150 mb-4">
                ...
                <div className="flex flex-wrap">
                  ...
                  <div>
                    <div className="mb-4">
                      <h2 className="text-l text-gray-400 font-bold p-1 inline-block">IPV4 DOWNSTREAMS:</h2>
                      <b>{ipv4Downstreams}</b>
                    </div>

                    <div>
                      <h2 className="text-l text-gray-400 font-bold p-1 inline-block">IPV6 DOWNSTREAMS:</h2>
                      <b>{ipv6Downstreams}</b>
                    </div>
                  </div>
                </div>
