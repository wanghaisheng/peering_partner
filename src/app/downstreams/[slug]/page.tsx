        ...
        <div className="flex flex-col min-h-screen overflow-hidden">
            <div className="flex flex-row min-h-screen bg-gray-100 text-gray-800">
                <div style={{ top: 0, left: 0, zIndex: 1, height: "100vh" }}>
                    <ASNSideNavbar activeOption="Downstreams" sidebarOpen={true} slug={asn_number} />
                </div>
                ...
                <main className="main flex flex-col flex-grow -ml-64 md:ml-0 transition-all duration-150 ease-in">
                    ...
                    <div className="mt-4 pt-24 md:mt-8 lg:mt-12 mx-4 md:mx-0 pl-8 overflow-y-auto flex-grow">
                        ...
                        <DownstreamDetailsInfo res_downstreams={res_asn_downstreams} asn_number={asn_number} />
                        <hr />
